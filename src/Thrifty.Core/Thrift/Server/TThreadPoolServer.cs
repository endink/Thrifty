...
namespace Thrift.Server
{
    ...
    public class TThreadPoolServer : TServer
    {
        ...
        private readonly LimitedConcurrencyLevelTaskScheduler _scheduler = null;
        private readonly TaskFactory _taskFactory = null;
        ...
        {
            _scheduler = new LimitedConcurrencyLevelTaskScheduler(maxThreadPoolThreads);
        ...
        public override void Serve()
        {
            ...
            while (!stop)
            {
                ...
                try
                {
                    ...
                    _taskFactory.StartNew(this.Execute, client);
                }
                catch (TTransportException ttx)
                {
