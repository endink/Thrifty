...
{
    public class FramedClientChannel : AbstractClientChannel
    {
        public FramedClientChannel(IChannel nettyChannel, ITimer timer, TDuplexProtocolFactory protocolFactory, ILoggerFactory loggerFactory = null) 
